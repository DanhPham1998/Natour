...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFuaGtpZDAwMCIsImEiOiJjbDk5Y2k0ZHEwMnZoM29yc3o1ZnlhZHJxIn0.Vn_fGYsoB6w1iofT1Zs0_Q';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error logout! Please try again');
          case 10:
          case "end":
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51LuTd6GjRUTIJkZzfse8XFtUlDu2necY2ODaJYcTfQzWZsAEIQxWNOLGga77MO2FKi6CG7fcYgwkKP2ueOurvoN300KObik9q8');
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    ...
    form.append('currentPassword', document.getElementById('password-current-update-me').value);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('password-confirm').value; // Dùng await vì để chờ updateSettings xong rồi thực hiển xoá value ở các input (passwordCurrent,password,passwordConfirm)
...
},{"./mapbox":"mapbox.js","./login":"login.js","./updateSetting":"updateSetting.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
